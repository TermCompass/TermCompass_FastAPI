...
df.to_sql("list_law_", conn2, if_exists="replace", index=False)

excel_file = "./test/267337_keyword_개인정보_보호위원회_직제_시행규칙.xlsx"
df = pd.read_excel(excel_file)
df.to_sql("267337_keyword_개인정보_보호위원회_직제_시행규칙", conn2, if_exists="append", index=False)

excel_file = "./test/267337_개인정보_보호위원회_직제_시행규칙.xlsx"
df = pd.read_excel(excel_file)
df.to_sql("267337_개인정보_보호위원회_직제_시행규칙", conn2, if_exists="append", index=False)
